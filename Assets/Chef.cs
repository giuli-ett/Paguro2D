...
public class Chef : MonoBehaviour
{
    ...
    [SerializeField] private float velocit‡Movimento = 3f;
    [SerializeField] private float distanzaStop = 1f;
    [SerializeField] private float velocit‡Presa = 5f;
    ...
    void Update()
    {
        ...
        if (isGrabbing)
        {
            ...
            // Muove la mano verso líalto
            transform.position += Vector3.up * velocit‡Presa * Time.deltaTime;
            ...
            if (grabTimer >= durataPresa)
            {
                ...
                Debug.Log("Il paguro Ë stato catturato!");
        ...
        if (distance > distanzaStop)
        {
            ...
            transform.position += (Vector3)(direction * velocit‡Movimento * Time.deltaTime);
        }
    }
